    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-charcoal text-ivory hover:bg-charcoal-light active:bg-charcoal dark:bg-white dark:text-charcoal dark:hover:bg-white/90 hover:shadow-lg hover:shadow-charcoal/10 dark:hover:shadow-white/5":
              variant === "primary",
            "bg-gold/10 text-gold-dark hover:bg-gold/20 border border-gold/20 hover:border-gold/40 hover:shadow-md hover:shadow-gold/5":
              variant === "secondary",
            "border border-charcoal/20 text-charcoal hover:bg-charcoal hover:text-ivory hover:border-charcoal dark:border-white/20 dark:text-white dark:hover:bg-white dark:hover:text-charcoal hover:shadow-lg":
              variant === "outline",
