      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-12 lg:gap-16">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-[13px] text-ivory/30 leading-relaxed max-w-xs">
            ...
            <div className="flex items-center gap-3 mt-8">
              ...
              <a href={SITE.social.facebook} target="_blank" rel="noopener noreferrer" className="group p-2.5 rounded-full border border-ivory/8 hover:border-gold/30 hover:bg-gold/5 transition-all duration-300" aria-label="Facebook">
                <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 text-ivory/30 group-hover:text-gold-light transition-colors" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
              </a>
              <a href={SITE.social.twitter} target="_blank" rel="noopener noreferrer" className="group p-2.5 rounded-full border border-ivory/8 hover:border-gold/30 hover:bg-gold/5 transition-all duration-300" aria-label="Twitter">
                <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 text-ivory/30 group-hover:text-gold-light transition-colors" fill="currentColor"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg>
              </a>
          ...
          <div>
            <h3 className="text-[10px] font-semibold uppercase tracking-[0.25em] text-ivory/20 mb-6">Shop</h3>
          ...
          <div>
            <h3 className="text-[10px] font-semibold uppercase tracking-[0.25em] text-ivory/20 mb-6">Customer Service</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="text-[10px] font-semibold uppercase tracking-[0.25em] text-ivory/20 mb-6">Help</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="text-[10px] font-semibold uppercase tracking-[0.25em] text-ivory/20 mb-6">Company</h3>
            <ul className="space-y-3">
        ...
        <div className="mt-16 pt-8 border-t border-ivory/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[11px] text-ivory/15">
            &copy; {new Date().getFullYear()} {SITE.name}. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <p className="text-[11px] text-ivory/15 flex items-center gap-1.5">
              Made with <Heart className="h-3 w-3 text-gold/40" /> in India
            </p>
            <button
            ...
            >
              <ArrowUp className="h-3 w-3 text-ivory/25 group-hover:text-gold-light transition-colors" />
            </button>
          </div>
        </div>
      </div>
