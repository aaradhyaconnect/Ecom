...
export async function generateMetadata({ params }: { params: Promise<{ category: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: `Browse our ${name} collection at Femme Drip. Premium designer clothing and artificial jewellery.`,
    alternates: {
      canonical: `/products/${category}`,
    },
    openGraph: {
      title: `${name} | Femme Drip`,
      description: `Browse our ${name} collection at Femme Drip.`,
