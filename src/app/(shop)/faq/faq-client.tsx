...
const fallbackFaqs = [
  {
    ...
    a: "Once your order ships, you'll receive an email with a tracking number. You can also check your order status in your Femme Drip account under Order History.",
  },
  {
