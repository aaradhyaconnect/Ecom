...
export default function LoginPage() {
  ...
  return (
    <div className="bg-ivory border border-ivory-dark/60 p-8 shadow-sm">
        ...
        {authMethod === "password" ? (
          <>
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-xs text-charcoal-muted hover:text-charcoal transition-colors">
                Forgot password?
              </Link>
            </div>
          </>
      ...
      <Button type="button" variant="outline" fullWidth isLoading={isLoading} onClick={handleGoogleLogin}>
      ...
      <p className="mt-6 text-center text-sm text-charcoal-muted">
        ...
        <Link href={`/signup?redirect=${encodeURIComponent(redirectTo)}`} className="font-medium text-charcoal hover:text-gold-dark transition-colors">
          Create one
        </Link>
      </p>
    </div>
