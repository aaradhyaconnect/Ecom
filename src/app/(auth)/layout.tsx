      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-block">
            <h1 className="text-2xl font-serif font-bold text-charcoal tracking-[0.35em]">FEMME DRIP</h1>
        ...
        <div className="text-center mt-8">
          <p className="text-[10px] uppercase tracking-[0.3em] text-charcoal-muted">&copy; {new Date().getFullYear()} Femme Drip</p>
        </div>
      </div>
    </div>
  );
