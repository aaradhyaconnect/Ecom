        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 border border-ivory-dark rounded-sm text-sm text-charcoal bg-ivory focus:border-gold focus:ring-0 focus:shadow-[0_0_0_3px_rgba(212,175,55,0.1)] transition-all duration-300"
            >
          ...
          <div>
            <label className="block text-sm font-medium text-charcoal mb-1.5">Admin Notes</label>
            <textarea
              value={editForm.notes}
              onChange={(e) => setEditForm({ ...editForm, notes: e.target.value })}
              rows={3}
              className="w-full px-4 py-2.5 border border-ivory-dark rounded-sm text-sm text-charcoal bg-ivory focus:border-gold focus:ring-0 focus:shadow-[0_0_0_3px_rgba(212,175,55,0.1)] transition-all duration-300 resize-none"
