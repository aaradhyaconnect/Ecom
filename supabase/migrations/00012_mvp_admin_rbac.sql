...
ALTER TABLE store_settings ADD COLUMN IF NOT EXISTS email_from_name TEXT DEFAULT 'Arcon Style';
ALTER TABLE store_settings ADD COLUMN IF NOT EXISTS email_from_address TEXT DEFAULT 'hello@arconstyle.com';
