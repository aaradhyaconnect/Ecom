...
('hero', 'Hero Banner', 'Welcome to Femme Drip', 'Premium self-designed clothing and exquisite artificial jewellery', true, 0, '{"slides": []}'),
...
('newsletter', 'Newsletter', 'Join the Femme Drip Circle', 'Subscribe for exclusive access to new drops and member-only offers', true, 7, '{}');
