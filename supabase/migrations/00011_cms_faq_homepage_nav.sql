...
('hero', 'Hero Banner', 'Welcome to Arcon Style', 'Premium self-designed clothing and exquisite artificial jewellery', true, 0, '{"slides": []}'),
...
('newsletter', 'Newsletter', 'Join the Arcon Style Circle', 'Subscribe for exclusive access to new drops and member-only offers', true, 7, '{}');
